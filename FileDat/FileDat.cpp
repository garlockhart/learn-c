...
int main() { 
    ...
    { 
        ...
        printf("\n\t Pilihan : "); scanf("%d", &pil); 
        switch (pil) { 
            case 1 : { Entry_file(); break; } 
            case 2 : { Sort_file(); break; } 
            case 3 : { Tampil_file(); break; } 
            default : { return(0); } 
        } 
    } 
} 
...
{ 
    ...
    if ((f_mhs=fopen("MahasiswaJTK.dat", "ab+"))==NULL) 
    { 
...
{ 
    ...
    if ((f_mhs=fopen("MahasiswaJTK.dat", "rb"))==NULL) 
    { 
        printf ("File tidak dapat dibuka\n"); 
        exit(1); 
    } 
...
{ 
    ...
    { 
        ...
        { 
            ...
            if ((strcmp(dt.Kelas,Temp.Kelas)>0) || ((strcmp(dt.Kelas,Temp.Kelas)==0) && (strcmp(dt.NIM,Temp.NIM)>0))) { 
                fseek(f_mhs, i*(sizeof(Mhs)+1)+i, SEEK_SET); 
